...
function render (to, from, next) {
  ...
  let context = getContext({ to, isClient: true, next: _next.bind(this), error: this.error.bind(this) })
...
function addHotReload ($component, depth) {
  ...
  $component.$vnode.context.$forceUpdate = () => {
    ...
    let context = getContext({ route: router.currentRoute, isClient: true, next: next.bind(this), error: this.error })
